          ...
          <div class="mega-box">
            <div class="content">           
              <div class="row">
                ...
                <ul class="mega-links">
                  <li><a href="updatemore/torrent.php">¿Como descargar Utorrent?</a></li>
                  <li><a href="updatemore/download.php">¿Como descargar Un juego?</a></li>
                  <li><a href="updatemore/update.php">¿Como actualizar un juego?</a></li>
                  <li><a href="updatemore/extract.php">¿Como extraer la actualizacion de un juego?</a></li>
                  <li><a href="updatemore/bypass.php">¿Como evitar el limite de descarga?</a></li>
                </ul>
              </div>
