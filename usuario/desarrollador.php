...
<!DOCTYPE html>
<html lang="es">
<title>GameWar | Desarrollador</title>
<head>
...
<div class="tutorial"><h2>Añadir desarrollador</h2>
<ul class="breadcrumb">
  <h5>
    <li>
...
<a class="txt7" href="adddesarrollador.php">Agregar desarrollador</a>
					...
					<div class="table100-head">
						...
						<table>
							...
							<?php foreach($categorias as $cate): ?>
								<tr class="row100 head">
									<td class="cell100 column3"><?= $cate->nombre_desarrollador; ?></td>
									<td class="cell100 column3"> 
										<?php if(($cate ->estatus_desarrollador) == 1){
                      ...
                      href='editdesarrollador.php?id_desarrolladores=<?=$cate->id_desarrolladores;?>' >Editar </a>
                      ...
                      href='deletedesarrollador.php?id_desarrolladores=<?=$cate->id_desarrolladores;?>' onclick="return confirm('¿Esta seguro de eliminar esto?');"> Borrar</a>
										</td>
								</tr>
                <?php endforeach; ?>
					...
					<center>
					<a class="txt6" href="adddesarrollador.php">Agregar desarrollador</a>
					</center>
				</div>
			</div>
		</div>
