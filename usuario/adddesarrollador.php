...
if (isset ($_POST['name'])  && isset($_POST['categoriaStatus']) ) {
  ...
  $sql = 'INSERT INTO desarrolladores (nombre_desarrollador, estatus_desarrollador) VALUES(:name, :categoriaStatus)';
...
<div class="tutorial"><h2>Añadir desarollador</h2>
<ul class="breadcrumb">
  <h5>
    <li>
    ...
    <li>
      <a href="desarollador.php"> Añadir desarollador</a>
    </li>
  </h5>
</ul>
</div>
...
<div class="contact_form">
    <div class="formulario">      
      <h1>Añadir desarollador</h1>
          <form method="post" id="formulario">       
                <p>
                  <label for="nombre" class="colocar_nombre">Escribe a el desarollador
                    <span class="obligatorio">*</span>
                  </label>
                    <input type="text" name="name" id="username" placeholder="Escribe una desarollador">
                </p>
                <p>
